...
If this guidance overlaps with `ask-user-directly`, `ask-user-directly` takes precedence when design, approach, scope, or product decisions require user input.
